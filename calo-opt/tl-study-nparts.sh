...
#SBATCH --gpus=1
#SBATCH --chdir=/home/users/m/mulligas/calo_working/tl-study-nparts
#SBATCH --output=/home/users/m/mulligas/calo_working/tl-study-nparts/logs/%A_%a.out
...
srun apptainer exec --nv -B /srv,/home \
	   /home/users/m/mulligas/temp_container/jan_framework.sif \
	      python execute.py \
	      --run 0 --experiment tl_nparts_200_100 --config configs/tl_n_part.yaml
